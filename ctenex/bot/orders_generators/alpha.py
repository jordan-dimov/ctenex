...
class AlphaOrdersGenerator(IOrdersGenerator):
    ...
    def generate_orders(
        ...
        min_profit = tick_size * Decimal(AlphaOrdersGenerator.MIN_PROFIT_TICKS)
            ...
            if i == 0:
                ...
                if randrange(2) == 0:
                    ...
                    order_price = price + tick_size * Decimal(
                        randrange(
                            AlphaOrdersGenerator.MIN_PROFIT_TICKS,
                            AlphaOrdersGenerator.RANDOM_TICKS_FACTOR,
                        )
                    )
                else:
